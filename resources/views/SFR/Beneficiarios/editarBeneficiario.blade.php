        ...
        <div style = "position:relative;
                                                ...
                                                <div class = "" style = "position: relative;
                                                                ...
                                                                <div class = "row mb-3">
                                                                                ...
                                                                                <label class="mb-3" >Identificación oficial (Adverso)</label>
                                                                                        <input type="file" name = "cop_fot_iden_ad" class="form-control" value = "{{ $allDataBenef->cop_fot_iden_ad }}">
                                                                                        </div>
                                                                ...
                                                                <div class = "row mb-3">
                                                                                ...
                                                                                <div class = "col">
                                                                                <label class="mb-3">Aux</label>
                                                                                       
                                                                                        <input type="text" name = "cop_fot_iden_rev" class="form-control" value = "{{ $allDataBenef->cop_fot_iden_rev }}">
              ...
              <div style = "position: absolute;
                ...
                <scroll-container>
                        ...
                        <img src = "{{ url('storage/'.$allDataBenef->cop_fot_iden_ad) }}" width = "100%" height = "100%">
                        ...
                        ">
                                 ...
                                 <img src = "{{ url('storage/'.$allDataBenef->cop_fot_iden_rev) }}" width = "100%" height = "100%">
                        </div>
                        ...
                        <img src = "{{ url('storage/'.$allDataBenef->cop_fot_comprobante) }}" width = "100%" height = "100%">
                        ...
                        <img src = "{{ url('storage/'.$allDataBenef->cop_fot_curp) }}" width = "100%" height = "100%">
                        ...
                        <img src = "{{ url('storage/'.$allDataBenef->cop_fot_fur) }}" width = "100%" height = "100%">
